  ...
  return (
    <main className="flex flex-col h-screen max-w-4xl mx-auto p-4 md:p-8 justify-center items-center">
      <div className="flex flex-col items-center gap-6 text-center">
        <div
          className="p-4 bg-blue-600 rounded-2xl shadow-lg shadow-blue-600/20"
        ...
        <div className="max-w-md text-slate-300 leading-relaxed">
          <p>
            Access our secure knowledge base and neural core analysis. A
            one-time payment is required to initialize your secure session.
          </p>
        </div>
